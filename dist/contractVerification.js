 ...
 */
export function normalizeBytecode(bytecode) {
 ...
 */
export function verifyBytecode(onChainBytecode, artifact) {
 ...
 */
export async function fetchContractScript(address, electrumUrl = 'https://electrumx.lifestone.cash') {
 ...
 * @returns Verification result
 */
export async function verifyContract(address, contractName, electrumUrl) {
...
//# sourceMappingURL=contractVerification.js.map