...
import {
  ...
  ContractSkeletonCard, ContractSkeletonLine, StatValue, StatLabel,
  AnalyticsGrid, AnalyticsCard, AnalyticsValue, AnalyticsLabel,
  ProgressBar, ProgressFill, ContractList, ContractCard,
  ContractInfo, ContractAddress, QRCodeSection, QRCodeWrapper,
  CopyButton, ContractBalance, ContractStatus, ContractActions,
  ActionButton, WithdrawButton, CancelButton, DepositButton, ExtendButton,
  EmptyState, TransactionSection, FilterBar, FilterButton,
  TransactionList, TransactionItem, SortBar, SortLabel, SortSelect,
  LabelInput, LabelButton, SaveLabelBtn, RemoveLabelBtn,
  LabelDisplay, WalletLabel, BackupSection, BackupActions,
  BackupButton, ExportBtn, ImportBtn, FileInput,
  PasswordInput, PasswordLabel, MessageBox, EncryptNote,
                ...
                <div key={c.address} style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)', marginTop: '4px' }}>
                      ...
                      {(() => {
                        const unlockDate = estimateUnlockDate(c.lockEndBlock, currentBlock ?? undefined);
                        return unlockDate && (
